...
import { Menu, X, Sun, Moon, Github, Sparkles, Send } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {/* Uploaded resume */}
          <a
            href={content.resume?.url ? '/api/resume/file?view=1' : '#hero'}
            target={content.resume?.url ? '_blank' : undefined}
            rel={content.resume?.url ? 'noopener noreferrer' : undefined}
        ...
        >
          ...
          <div className="pt-4 border-t border-slate-800 light:border-slate-200 flex flex-col gap-3">
            ...
            >
              ...
              <span>Ask Chetan's AI Assistant</span>
            </button>
